...
d3.json(
    ...
    function(json){
        ...
        // draw a path for each fature/country
        countries = countriesGroup
            ...
            .on("mouseover", function(d, i) {
                d3.select("#countryLabel" + d.properties.STUSPS10).style("display", "block");
            })
            .on("mouseout", function(d, i) {
                d3.select("#countryLabel" + d.properties.STUSPS10).style("display", "none");
            })
        ...
        countryLabels = countriesGroup
            ...
            //add onclick action to zoom into clicked country
            .on("click", function(d,i) {
                d3.selectAll(".country").classed("country-on", false);
